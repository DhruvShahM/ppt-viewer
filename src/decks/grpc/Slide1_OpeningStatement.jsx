    ...
    <div className="w-full h-screen flex flex-col items-center justify-center overflow-y-auto p-4 relative">
      ...
      <div className="w-full max-w-5xl z-10 flex flex-col items-center">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-2xl text-slate-300 max-w-3xl mb-12 leading-relaxed mx-auto"
          >
          ...
          >
            {['Fast', 'Efficient', 'Scalable'].map((word, idx) => (
              <motion.span
                key={word}
                className="px-6 py-3 bg-slate-800/50 border border-cyan-500/50 rounded-full text-cyan-300 font-semibold backdrop-blur-sm"
