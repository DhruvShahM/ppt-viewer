    ...
    <div className="w-full h-screen flex flex-col items-center justify-center overflow-y-auto p-4 relative">
      ...
      <div className="w-full max-w-5xl z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {features.map((feature, idx) => (
            ...
            >
              ...
              />
              <div className="relative bg-slate-800/50 border border-slate-700/50 rounded-xl p-8 h-full flex flex-col items-center text-center backdrop-blur-sm">
                <motion.div
                  animate={{
                    y: [0, -10, 0],
                    scale: [1, 1.1, 1],
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-xl p-6 text-center backdrop-blur-sm"
        >
